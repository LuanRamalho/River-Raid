...
# Nome do arquivo JSON para armazenar o High Score
...
# Função para carregar o High Score de um arquivo JSON
def load_high_score():
    try:
        ...
        return 0  # Se o arquivo não existir, o High Score começa em 0

# Função para salvar o High Score em um arquivo JSON
...
# Game over function
def game_over(screen, score, kills, high_score):
    ...
    return high_score  # Retorna o High Score atualizado 
    ...
    while running:
        ...
        if pygame.sprite.spritecollide(player, helicopters, False) or pygame.sprite.spritecollide(player, boats, False):
            if not player.invulnerable:
                high_score = game_over(screen, score, kills, high_score)  # Passa e atualiza o High Score
                running = False
        ...
        high_score_text = font.render(f'High Score: {high_score}', True, WHITE)  # Exibe o High Score
